...
images: ['/blog/static/images/supertokens.png']
tags: ['nextjs', 'expressjs', 'supertokens', 'authentication', 'fullstack', 'tutorial']
draft: false
---
...
Run the following command in the root of your repository, i.e. _outside_ the `/backend` folder.
