...
Note that you do _NOT_ need to turn your root layout into a client component with `use client` to make this work. This works with server components as well.
